...
if run_firk_basic_group("AFFINENESS")
...
if run_firk_basic_group("CONVERGENCE")
...
if run_firk_basic_group("INTERPOLATION")
...
if run_firk_basic_group("NONLINEAR")
...
if run_firk_basic_group("KWARGS")
    @testset "Nested nlsolve kwargs in FIRK" begin
        ...
        nested = true
        nested_nlsolve_kwargs = (; abstol = 1.0e-6, reltol = 1.0e-6)
...
if run_firk_basic_group("PARAMETERS")
...
if run_firk_basic_group("PARAMETERS")
    @testset "Test unknown parameters estimation with SciMLStructures" begin
        ...
        sol_vec = solve(bvp_vec, RadauIIa5(; nested_nlsolve = true), dt = 0.05)
        ...
        sol_struct = solve(bvp_struct, RadauIIa5(; nested_nlsolve = true), dt = 0.05)
...
if run_firk_basic_group("INITIAL_GUESS")
    @testset "Test initial guess" begin
        ...
        sol1 = solve(bvp1, RadauIIa5(; nested_nlsolve = true), dt = 0.1, adaptive = false, nlsolve_kwargs = (; maxiters = 0))
        @test sol1.u == u_guess
