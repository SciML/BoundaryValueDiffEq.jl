...
BoundaryValueDiffEqAscher.jl is a component of the [BoundaryValueDiffEq.jl](https://github.com/SciML/BoundaryValueDiffEq.jl) monorepo. It provides the Ascher collocation methods for solving boundary value problems, including problems with algebraic constraints.
