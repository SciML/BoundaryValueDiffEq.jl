...
BoundaryValueDiffEqShooting.jl is a component of the [BoundaryValueDiffEq.jl](https://github.com/SciML/BoundaryValueDiffEq.jl) monorepo. It provides the single and multiple shooting methods for solving boundary value problems by reduction to initial value problems.
